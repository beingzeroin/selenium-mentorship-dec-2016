...
public class Week3EmployeeTests {
	...
	public void deleteEmployeeTest() {
		...
		if (actualHomePageText.equals(expectedHomePageText)) {
			...
			// 10. Using an employee ID, click on checkbox in the result table
			// in front of empid row
			...
			// 12. On confirmation dialog (Note: This isn't an ALERT, you can
			// inspect it) click OK button.
			...
			// 15. Get count of rows in the results table and store in
			// finalCount variable (int)
			...
			// 17. If finalCount+1 is equal to originalCount, print Passed,
			...
			// 18. Also verify that employee id deleted just now isn't shown in
			// the table anymore.
	...
	public void downloadEmpImportFile() throws InterruptedException {
		...
		if (actualHomePageText.equals(expectedHomePageText)) {
			...
			String downloadPath = "C:\\Users\\Abishek\\Downloads";
			...
			WebElement browseFile = driver.findElement(By.id("pimCsvImport_csvFile"));
			Thread.sleep(1000);
			browseFile.sendKeys("C:\\Users\\Abishek\\Downloads\\importData.csv");
			Thread.sleep(1000);
